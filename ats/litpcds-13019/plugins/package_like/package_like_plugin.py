...
class PackageLikePlugin(Plugin):
    """
    ...
    def create_configuration(self, plugin_api_context):
        ...
        for node in nodes:
            for package in node.query("package", is_initial=True):
                tasks.append(
                    ConfigTask(node, package, "Create", "package",
                               package.name,
            ...
            for package in node.query("package", is_for_removal=True):
                tasks.append(
